...
export class MoeraNode extends Caller {
     ...
     */
    async searchNodeSuggestions(
        query: string | null = null, sheriff: string | null = null, limit: number | null = null
    ): Promise<API.SearchNodeInfo[]> {
        const location = ut`/search/nodes/suggestions`;
        const params = {query, sheriff, limit};
        return await this.call("searchNodeSuggestions", location, {
